            ...
            <div class="col-md-8 content-main">
                ...
                <ol class="breadcrumb">
                    <li>
                        ...
                        <a href="#">Readers </a></li>
                    <li class="active"  >Meet our Professional Psychic Readers</li>
                </ol>

                <?php foreach($readers as $reader) { ?>
                <h2 class="title"><?php echo $reader['username']; ?></h2>
                <p class="author"><span class="name">PIN: <?php echo $reader['pin']; ?><br/><?php echo $reader['area']; ?></span></p>
                <div class="col-sm-2">
                    <p><img class="img-fluid" src="public_html/images/readers/slider/<?php echo strtolower($reader['username']); ?>.png" class="img-responsive" alt="" height="120" width="120"></p>
                </div>
                <div class="col-sm-8">
                    <p>
                        <?php echo substr(str_replace('\r\n', '', $reader['profile']), 0, 200); ?>...
                    </p>
                </div>
                <section class="post-footer">
                    <div class="wrap-readmore">
                        <div class="wrap">
                            <a href="/readers/<?php echo $reader['id'];?>" class="btn btn-primary pull-right">Read Bio...</a>
                        </div>
                    </div>
                </section>
                <p>&nbsp;</p>
