    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 content-main">
                ...
                <p class="author">By: <span class="name">Jayson Lynn</span> / <span class="date"><?php echo substr($article['datetime'], 0, 10); ?></span></p>
                <!--<p><img src="public_html/images/img-2.jpg" class="img-responsive" alt=""></p>-->
                <p>
                    <?php echo substr(str_replace('\r\n', '', $article['content']), 0, 500); ?>...</p>
                </p>

                <section class="post-footer">
                    <div class="wrap-readmore">
                        <div class="wrap">
                            <a href="/articles/<?php echo $article['id'];?>" class="btn btn-primary pull-right">Read More</a>
                        </div>
                    </div>
                </section>
                <?php
