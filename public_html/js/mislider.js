...
var MiSlider = function( stageEl, options ) {
	...
	o.setup = function() {
        ...
        //console.log(o.indexCurrent);
        var name_current = $( "li.mis-slide:nth-child("+(o.indexCurrent + 1)+")").find('img').attr('id');
		var image_name_current = name_current + "_mobile.png";
		$( "li.mis-slide:nth-child("+(o.indexCurrent + 1)+")").find('img').attr("src","/public_html/images/readers/slider/"+ image_name_current);
	...
	o.animateSlides = function( indexTo, afterTrans ) {
		...
		o.slider.animate({
			...
			complete: function() {
				...
				//var image_ctr = $('li.mis-slide').length - 1;
				var image_ctr = $('li.mis-slide').not('.mis-clone').length - 1;
				console.log(image_ctr);
				if (indexTo == 0) {

					var indexReplace = 1;
					var right_index = 2;
					var name_right = $( "li.mis-slide:nth-child("+(right_index)+")").find('img').attr('id');
					var image_name_right = name_right + ".png";
					$( "li.mis-slide:nth-child("+(right_index)+")").find('img').attr("src","/public_html/images/readers/slider/"+ image_name_right);

					// rightmost image
					var name_rightmost = $( "li.mis-slide:nth-child("+(image_ctr + 1)+")").find('img').attr('alt');
					console.log(name_rightmost);
					var image_name_rightmost = name_rightmost + ".png";
					$( "li.mis-slide:nth-child("+(image_ctr + 1)+")").find('img').attr("src","/public_html/images/readers/slider/"+ image_name_rightmost);


					console.log("Right" + image_name_right);

				} else {
					if (indexTo == image_ctr) {
						var left_index = indexTo;
						var name_left = $( "li.mis-slide:nth-child("+(left_index)+")").find('img').attr('alt');
						var image_name_left = name_left + ".png";
						$( "li.mis-slide:nth-child("+(left_index)+")").find('img').attr("src","/public_html/images/readers/slider/"+ image_name_left);
						
						console.log("Left" + image_name_left);
					} else {
						var right_index = indexTo + 2;
						var left_index = indexTo;

						var name_left = $( "li.mis-slide:nth-child("+(left_index)+")").find('img').attr('alt');
						var name_right = $( "li.mis-slide:nth-child("+(right_index)+")").find('img').attr('alt');
						var image_name_left = name_left + ".png";
						var image_name_right = name_right + ".png";
				...
				var src = $( ".mis-current" ).find( "img" ).attr("src");
				name = $( ".mis-current" ).find( "img" ).attr("alt");
				var image_name = name + "_mobile.png";
				///console.log(image_name);				
				$( ".mis-current" ).find( "img" ).fadeOut(100, function(){
					$( ".mis-current" ).find( "img" ).attr("src","/public_html/images/readers/slider/"+ image_name).bind('onreadystatechange load', function(){
